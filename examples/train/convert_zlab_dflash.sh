...
SRC="${SRC:-/home/models/Qwen3.5-9B-DFlash}"
VERIFIER="${VERIFIER:-/home/models/Qwen3.5-9B}"
OUT="${OUT:-/home/models/Qwen3.5-9B-DFlash-spec}"
...
echo "    ALLAVA_INPUTS=\"/home/wenxuan/ALLaVA-4V/allava_laion/ALLaVA-Caption-LAION-4V.json /home/wenxuan/ALLaVA-4V/allava_laion/ALLaVA-Instruct-LAION-4V.json\" \\"
echo "    ALLAVA_IMAGE_ROOT=/home/wenxuan/ALLaVA-4V MAX_SAMPLES=100000 EPOCHS=2 \\"
